...
*/
  ...
  function startIntro()
  {
    ...
    swagShader = new ColorSwap();
    // gfDance removed: disable loading of gfDanceTitle asset
    ...
    //
    // do not add gfDance to the state or set shader to avoid using gfDanceTitle asset
    // add(gfDance);
